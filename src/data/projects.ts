import Sanvia from "../assets/sanvia.png";
import PromptSlide from "../assets/promptslide.png";
import CloudNotes from "../assets/cloudnotes.png";
import FinanceDashboard from "../assets/financedashboard.png";
import MyOnlineMeal from "../assets/myonlinemeal.png";
...
export const projects = [
    ...
    {
        title: "CloudNotes",
        description: "Repository: CloudNotes Description: React web app for effortless note management. Create, update, and delete notes seamlessly. User-friendly interface for efficient note-taking, perfect for organizing thoughts and tasks. Similar to Google Notes.",
        image: CloudNotes,
